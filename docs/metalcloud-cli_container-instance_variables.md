## metalcloud-cli container-instance variables

Show the variables of a container instance

### Synopsis

Show the variables available in the context of a container instance.
...
```
metalcloud-cli container-instance variables infrastructure_id_or_label container_instance_id [flags]
```
