## metalcloud-cli container-instance-group config

Show the pending configuration of a container instance group
...
```
metalcloud-cli container-instance-group config infrastructure_id_or_label container_instance_group_id [flags]
```
