## metalcloud-cli external-connection interface get

Get one interface of an external connection

### Synopsis

Get the details of a single external connection interface.
...
```
metalcloud-cli external-connection interface get external_connection_id_or_label interface_id [flags]
```
