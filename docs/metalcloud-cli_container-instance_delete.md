## metalcloud-cli container-instance delete

Delete a container instance

### Synopsis

Delete a container instance from an infrastructure.
...
```
metalcloud-cli container-instance delete infrastructure_id_or_label container_instance_id [flags]
```
