## metalcloud-cli endpoint-instance-group network disconnect

Remove a network connection from an endpoint instance group
...
```
metalcloud-cli endpoint-instance-group network disconnect endpoint_instance_group_id connection_id [flags]
```
