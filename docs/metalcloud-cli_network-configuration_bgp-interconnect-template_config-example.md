## metalcloud-cli network-configuration bgp-interconnect-template config-example

Generate example configuration template for network device BGP interconnect configuration template
...
```
metalcloud-cli network-configuration bgp-interconnect-template config-example [flags]
```
