## metalcloud-cli container-instance credentials

Show the credentials of a container instance
...
```
metalcloud-cli container-instance credentials infrastructure_id_or_label container_instance_id [flags]
```
