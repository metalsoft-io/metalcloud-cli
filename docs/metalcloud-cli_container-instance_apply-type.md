## metalcloud-cli container-instance apply-type

Apply a container type on a container instance
...
```
metalcloud-cli container-instance apply-type infrastructure_id_or_label container_instance_id container_type_id [flags]
```
