## metalcloud-cli container-instance-group interfaces

List the network interfaces of a group

### Synopsis

List the network interfaces of a container instance group.
...
```
metalcloud-cli container-instance-group interfaces infrastructure_id_or_label container_instance_group_id [flags]
```
