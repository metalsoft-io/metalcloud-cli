## metalcloud-cli network-configuration device-template delete
...
```
metalcloud-cli network-configuration device-template delete <network_device_configuration_template_id> [flags]
```
