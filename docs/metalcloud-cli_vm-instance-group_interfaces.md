## metalcloud-cli vm-instance-group interfaces

List the network interfaces of a VM instance group
...
```
metalcloud-cli vm-instance-group interfaces infrastructure_id_or_label vm_instance_group_id [flags]
```
