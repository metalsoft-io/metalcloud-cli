## metalcloud-cli container-instance power-status

Get the power status of a container instance

### Synopsis

Get the current power status of a container instance.
...
```
metalcloud-cli container-instance power-status infrastructure_id_or_label container_instance_id [flags]
```
