## metalcloud-cli file-share snapshot create

Create a new snapshot for a file share

### Synopsis

Create a new snapshot for a specific file share within an infrastructure.
...
```
metalcloud-cli file-share snapshot create infrastructure_id_or_label file_share_id [flags]
```
