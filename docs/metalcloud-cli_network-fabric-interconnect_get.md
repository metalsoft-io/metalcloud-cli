## metalcloud-cli network-fabric-interconnect get

Get network fabric interconnect details

### Synopsis

Get the details of a network fabric interconnect, including its deploy preview.
...
```
metalcloud-cli network-fabric-interconnect get interconnect_id_or_label [flags]
```
