## metalcloud-cli server-instance-group network acl add

Add a security rule to a network connection

### Synopsis

Add a security rule to one network connection of a server instance group.
...
```
metalcloud-cli server-instance-group network acl add server_instance_group_id connection_id [flags]
```
