## metalcloud-cli point-to-point-link allocation-strategy get

Get one allocation strategy

### Synopsis

Get the details of one allocation strategy of a point-to-point link.
...
Examples:
  metalcloud point-to-point-link allocation-strategy get 12 ipv4 3

```
metalcloud-cli point-to-point-link allocation-strategy get link_id family strategy_id [flags]
```
