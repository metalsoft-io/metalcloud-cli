## metalcloud-cli fabric link-aggregation list

List the link aggregations of a fabric

### Synopsis

List all link aggregations of a network fabric.
...
```
metalcloud-cli fabric link-aggregation list fabric_id [flags]
```
