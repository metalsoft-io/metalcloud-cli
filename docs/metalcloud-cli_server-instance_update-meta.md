## metalcloud-cli server-instance update-meta

Update the metadata of a server instance

### Synopsis

Update the metadata (tags) of a server instance.
...
```
metalcloud-cli server-instance update-meta server_instance_id [flags]
```
