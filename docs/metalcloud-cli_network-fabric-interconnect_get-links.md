## metalcloud-cli network-fabric-interconnect get-links

List the links of an interconnect

### Synopsis

List the links of a network fabric interconnect. Each link binds one fabric and
...
```
metalcloud-cli network-fabric-interconnect get-links interconnect_id_or_label [flags]
```
