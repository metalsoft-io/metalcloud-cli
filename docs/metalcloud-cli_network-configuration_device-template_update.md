## metalcloud-cli network-configuration device-template update
...
```
metalcloud-cli network-configuration device-template update <network_device_configuration_template_id> [flags]
```
