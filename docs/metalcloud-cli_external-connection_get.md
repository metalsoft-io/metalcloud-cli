## metalcloud-cli external-connection get

Get external connection details

### Synopsis

Get the details of an external connection.
...
```
metalcloud-cli external-connection get external_connection_id_or_label [flags]
```
