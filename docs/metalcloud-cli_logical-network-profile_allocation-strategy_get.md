## metalcloud-cli logical-network-profile allocation-strategy get

Get one allocation strategy

### Synopsis

Get the details of one allocation strategy of a logical network profile.
...
Examples:
  metalcloud logical-network-profile allocation-strategy get 12 ipv4 3

```
metalcloud-cli logical-network-profile allocation-strategy get logical_network_profile_id family strategy_id [flags]
```
