## metalcloud-cli endpoint-instance-group config

Get the pending configuration of an endpoint instance group

### Synopsis

Get the pending (not yet deployed) configuration of an endpoint instance group.
...
```
metalcloud-cli endpoint-instance-group config endpoint_instance_group_id [flags]
```
