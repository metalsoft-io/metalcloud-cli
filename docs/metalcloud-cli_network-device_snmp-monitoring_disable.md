## metalcloud-cli network-device snmp-monitoring disable

Unsubscribe a network device from SNMP monitoring
...
```
metalcloud-cli network-device snmp-monitoring disable <network_device_id> [flags]
```
