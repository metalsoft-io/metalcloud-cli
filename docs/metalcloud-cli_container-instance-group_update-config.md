## metalcloud-cli container-instance-group update-config

Update the pending configuration of a container instance group
...
```
metalcloud-cli container-instance-group update-config infrastructure_id_or_label container_instance_group_id [flags]
```

### Options

```
      --config-source string   Source of the container instance group configuration updates. Can be 'pipe' or path to a JSON/YAML file.
