## metalcloud-cli subnet remove-ip-range

Remove an IP range from a subnet

### Synopsis

Remove one IP range from a subnet.
...
```
metalcloud-cli subnet remove-ip-range subnet_id range_id [flags]
```

### Options

```
  -h, --help   help for remove-ip-range
```
