...
List network device link aggregation configuration templates with optional filtering

### Synopsis

List all network device link aggregation configuration templates with optional filtering.
...
```
metalcloud-cli network-configuration link-aggregation-template list [flags]
```
