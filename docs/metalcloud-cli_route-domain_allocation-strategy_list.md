## metalcloud-cli route-domain allocation-strategy list

List allocation strategies of one family

### Synopsis

List the allocation strategies of one family on a route domain.
...
Examples:
  metalcloud route-domain allocation-strategy list 12 l3-vlan

```
metalcloud-cli route-domain allocation-strategy list route_domain_id family [flags]
```
