## metalcloud-cli logical-network allocation-strategy get

Get one allocation strategy

### Synopsis

Get the details of one allocation strategy of a logical network.
...
Examples:
  metalcloud logical-network allocation-strategy get 12 ipv4 3

```
metalcloud-cli logical-network allocation-strategy get logical_network_id family strategy_id [flags]
```
