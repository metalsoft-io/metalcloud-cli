## metalcloud-cli vm-instance-group network list

Show the network configuration of a VM instance group

### Synopsis

Show the network endpoint group that carries the network connections of a
VM instance group.
...
```
metalcloud-cli vm-instance-group network list infrastructure_id_or_label vm_instance_group_id [flags]
```
