## metalcloud-cli container-instance-group network disconnect

Remove one network connection of a container instance group
...
```
metalcloud-cli container-instance-group network disconnect infrastructure_id_or_label container_instance_group_id connection_id [flags]
```
