## metalcloud-cli logical-network-profile allocation-strategy config-example
...
Examples:
  metalcloud logical-network-profile allocation-strategy config-example ipv4 -f yaml

```
metalcloud-cli logical-network-profile allocation-strategy config-example family [flags]
```
