## metalcloud-cli endpoint-instance-group network list

Get the network configuration of an endpoint instance group

### Synopsis

Get the network endpoint group that holds the network configuration of an
...
```
metalcloud-cli endpoint-instance-group network list endpoint_instance_group_id [flags]
```
