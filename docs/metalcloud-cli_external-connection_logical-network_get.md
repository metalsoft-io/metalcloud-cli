## metalcloud-cli external-connection logical-network get

Get one logical network attachment of an external connection

### Synopsis

Get the details of a single external connection logical network attachment.
...
```
metalcloud-cli external-connection logical-network get external_connection_id_or_label id [flags]
```
