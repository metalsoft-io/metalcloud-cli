## metalcloud-cli container-instance shutdown

Power off a container instance
...
```
metalcloud-cli container-instance shutdown infrastructure_id_or_label container_instance_id [flags]
```
