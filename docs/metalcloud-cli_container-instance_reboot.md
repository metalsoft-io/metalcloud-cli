## metalcloud-cli container-instance reboot

Reboot a container instance
...
```
metalcloud-cli container-instance reboot infrastructure_id_or_label container_instance_id [flags]
```
