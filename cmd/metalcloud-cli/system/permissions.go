...
const (
	...
	PERMISSION_PERMISSIONS_READ                                              = "permissions_read"
	PERMISSION_PERMISSIONS_WRITE                                             = "permissions_write"
	PERMISSION_QUOTA_PROFILES_READ                                           = "quota_profiles_read"
	PERMISSION_QUOTA_PROFILES_WRITE                                          = "quota_profiles_write"
	...
	PERMISSION_EXTERNAL_CONNECTIONS_READ                                     = "external_connections_read"
	PERMISSION_EXTERNAL_CONNECTIONS_WRITE                                    = "external_connections_write"
	PERMISSION_LOGICAL_NETWORK_INTERCONNECTS_READ                            = "logical_network_interconnects_read"
	PERMISSION_LOGICAL_NETWORK_INTERCONNECTS_WRITE                           = "logical_network_interconnects_write"
	PERMISSION_NETWORK_DEVICE_CONTROLLERS_READ                               = "network_device_controllers_read"
	PERMISSION_NETWORK_DEVICE_CONTROLLERS_WRITE                              = "network_device_controllers_write"
	PERMISSION_CONTAINER_TYPES_READ                                          = "container_types_read"
	PERMISSION_CONTAINER_TYPES_WRITE                                         = "container_types_write"
	PERMISSION_CONTAINERS_READ                                               = "containers_read"
	PERMISSION_CONTAINERS_WRITE                                              = "containers_write"
	PERMISSION_CONTAINER_INSTANCES_READ                                      = "container_instances_read"
	PERMISSION_CONTAINER_INSTANCES_WRITE                                     = "container_instances_write"
	PERMISSION_CONTAINER_INSTANCE_GROUPS_READ                                = "container_instance_groups_read"
	PERMISSION_CONTAINER_INSTANCE_GROUPS_WRITE                               = "container_instance_groups_write"
	PERMISSION_ENDPOINT_INSTANCES_READ                                       = "endpoint_instances_read"
	PERMISSION_ENDPOINT_INSTANCES_WRITE                                      = "endpoint_instances_write"
	PERMISSION_ENDPOINT_INSTANCE_GROUPS_READ                                 = "endpoint_instance_groups_read"
	PERMISSION_ENDPOINT_INSTANCE_GROUPS_WRITE                                = "endpoint_instance_groups_write"
	PERMISSION_CONFIGURATION_READ                                            = "configuration_read"
	PERMISSION_CONFIGURATION_WRITE                                           = "configuration_write"
	PERMISSION_EXTERNAL_SYSTEMS_READ                                         = "external_systems_read"
	PERMISSION_EXTERNAL_SYSTEMS_WRITE                                        = "external_systems_write"
...
func GetUserPermissions(ctx context.Context) (string, string, []string, error) {
	...
	// The API no longer exposes a per-user permission map. Permissions now live on
	// roles (managed via the security API) and there is no SDK endpoint to resolve
	// the effective permission keys for the current user. Returning a nil permission
	// list signals the caller to leave all commands visible; the server still
