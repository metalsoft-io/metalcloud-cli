...
func sharedDriveListCmd(c *Command, client metalcloud.MetalCloudClient) (string, error) {
	...
	return table.RenderTable("Shared drives", "", getStringParam(c.Arguments["format"]))
}
