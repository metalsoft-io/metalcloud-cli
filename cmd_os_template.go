	...
	},
	{
		...
		InitFunc: func(c *Command) {
			c.Arguments = map[string]interface{}{
				...
				"source-iso":      c.FlagSet.String("source-iso", _nilDefaultStr, yellow("(Required if 'provision-via-oob: true')")+"The local path for the source ISO image path."),
...
func createTemplateAssets(c *Command, client metalcloud.MetalCloudClient, repoTemplate RepoTemplate, templateName string) (string, error) {
	...
	createTemplateCommand.Arguments = map[string]interface{}{
		...
		"network_os_switch_driver":   createTemplateCommand.FlagSet.String("network-os-switch-driver", repoTemplate.NosSwitchDriver, yellow("(Required if network_os)")+"Network operating system (NOS) switch driver, e.g. 'sonic_enterprise'."),
		"network_os_switch_role":     createTemplateCommand.FlagSet.String("network-os-switch-role", repoTemplate.NosSwitchRole, yellow("(Flag)")+"Network operating system (NOS) switch role. Possible values: 'leaf', 'spine'."),
		"network_os_datacenter_name": createTemplateCommand.FlagSet.String("network-os-datacenter-name", repoTemplate.NosDatacenterName, yellow("(Flag)")+"Network operating system (NOS) datacenter name, e.g. 'dc1'"),
		"network_os_version":         createTemplateCommand.FlagSet.String("network-os-version", repoTemplate.NosVersion, yellow("(Required if network_os)")+"Network operating system (NOS) version, e.g. '4.0.2'"),
		"network_os_architecture":    createTemplateCommand.FlagSet.String("network-os-architecture", repoTemplate.NosArchitecture, yellow("(Required if network_os)")+"Network operating system (NOS) architecture. Possible values: 'x86_64', 'aarch64'."),
		"network_os_vendor":          createTemplateCommand.FlagSet.String("network-os-vendor", repoTemplate.NosVendor, yellow("(Required if network_os)")+"Network operating system (NOS) vendor, e.g. 'dellemc'"),
		"network_os_machine":         createTemplateCommand.FlagSet.String("network-os-machine", repoTemplate.NosMachine, yellow("(Required if network_os)")+"Network operating system (NOS) machine(equipment model) e.g.'s5212f_c3538'"),
	}
	...
	if createError != nil {
		...
		updateTemplateCommand.Arguments = map[string]interface{}{
			...
			"network_os_switch_driver":           updateTemplateCommand.FlagSet.String("network-os-switch-driver", repoTemplate.NosSwitchDriver, yellow("(Required if network_os)")+"Network operating system (NOS) switch driver, e.g. 'sonic_enterprise'."),
			"network_os_switch_role":             updateTemplateCommand.FlagSet.String("network-os-switch-role", repoTemplate.NosSwitchRole, yellow("(Flag)")+"Network operating system (NOS) switch role. Possible values: 'leaf', 'spine'."),
			"network_os_datacenter_name":         updateTemplateCommand.FlagSet.String("network-os-datacenter-name", repoTemplate.NosDatacenterName, yellow("(Flag)")+"Network operating system (NOS) datacenter name, e.g. 'dc1'"),
			"network_os_version":                 updateTemplateCommand.FlagSet.String("network-os-version", repoTemplate.NosVersion, yellow("(Required if network_os)")+"Network operating system (NOS) version, e.g. '4.0.2'"),
			"network_os_architecture":            updateTemplateCommand.FlagSet.String("network-os-architecture", repoTemplate.NosArchitecture, yellow("(Required if network_os)")+"Network operating system (NOS) architecture. Possible values: 'x86_64', 'aarch64'."),
			"network_os_vendor":                  updateTemplateCommand.FlagSet.String("network-os-vendor", repoTemplate.NosVendor, yellow("(Required if network_os)")+"Network operating system (NOS) vendor, e.g. 'dellemc'"),
			"network_os_machine":                 updateTemplateCommand.FlagSet.String("network-os-machine", repoTemplate.NosMachine, yellow("(Required if network_os)")+"Network operating system (NOS) machine(equipment model) e.g.'s5212f_c3538'"),
		}
