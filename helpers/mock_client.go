...
// Source: C:\Users\Costina.Batica\go/src/github.com/bigstepinc/metal-cloud-sdk-go//metal_cloud_client.go
...
// GetObjectByKind mocks base method
func (m *MockMetalCloudClient) GetObjectByKind(name string) (reflect.Value, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetObjectByKind", name)
	ret0, _ := ret[0].(reflect.Value)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetObjectByKind indicates an expected call of GetObjectByKind
func (mr *MockMetalCloudClientMockRecorder) GetObjectByKind(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetObjectByKind", reflect.TypeOf((*MockMetalCloudClient)(nil).GetObjectByKind), name)
}
